...
namespace TvTamer.Core.UnitTests
{
    ...
    public class TvEpisodeFilterTests
    {
        ...
        public void ValidEpisodeFormats()
        {
            ...
            var source = new[] { "The.Mindy.Project.S03E18.720p.HDTV.x264-KILLERS[rarbg]", "The.Mindy.Project.S03E18.720p.HDTV.x264-KILLERS[rarbg]", "The.Walking.Dead.S05E12.720p.HDTV.x264-KILLERS", "The.Simpsons.S26E15.REAL.REPACK.720p.HDTV.x264-KILLERS.mkv",
                "testing s1e2 file.avi","testing s01e02 - proper - eztv.mkv"};
